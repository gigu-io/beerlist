                    ...
                    <div className="mt-2 grid sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            <span
                                ...
                                className="hover:bg-secondary bg-highlight cursor-pointer w-full inline-flex justify-center py-2 px-4 border border-stroke rounded-md shadow-sm bg-white text-sm font-medium text-stroke transition-colors duration-400 ease-in-out"
                            >
